...
var gmaptogpxmain =  (function () 
{
	var error = 0,
	    version = '6.4j',
	    googledoc = "", // will hold retrieved google info
	    googleurl = "",
	    gpxvar = "", // will hold gHomeVPage structure, even for IE
	    routes = new Array(),
	    polylines = new Array(),
	    milestones = new Array(),
	    yelp = new Array(),
	    googlepage, // Will hold the page element that gets toggled. May change.
	    charset,
	...
	return function()
	{
		...
		// Get the Firefox content-proxy document, rather than just 'document'
